...
\paragraph{Representation Spaces}\index{Representation Spaces}\label{sec:rep_spaces}
...
\subparagraph{Lexical Matrix (L)}\index{Lexical Matrix (L)}
...
\subparagraph{Syntactical Matrix (S)}\index{Syntactical Matrix (S)}
...
\subparagraph{NER Standard Features Matrix (T)}\index{Standard Features Matrix (T)}
...
\paragraph{Test Datasets}\index{Test Datasets}We work with three corpus coming from different domains:
\begin{itemize}
